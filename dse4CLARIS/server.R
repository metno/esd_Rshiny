...
Z4$tx.djf.45 <- Z
load('data/dse.claris.tx.rcp45.mam.eof.rda')
Z4$tx.mam.45 <- Z
load('data/dse.claris.tx.rcp45.jja.eof.rda')
Z4$tx.jja.45 <- Z
load('data/dse.claris.tx.rcp45.son.eof.rda')
Z4$tx.son.45 <- Z

load('data/dse.claris.tx.rcp26.djf.eof.rda')
Z4$tx.djf.26 <- Z
load('data/dse.claris.tx.rcp26.mam.eof.rda')
Z4$tx.mam.26 <- Z
load('data/dse.claris.tx.rcp26.jja.eof.rda')
Z4$tx.jja.26 <- Z
load('data/dse.claris.tx.rcp26.son.eof.rda')
Z4$tx.son.26 <- Z

load('data/dse.claris.tx.rcp85.djf.eof.rda')
Z4$tx.djf.85 <- Z
load('data/dse.claris.tx.rcp85.mam.eof.rda')
Z4$tx.mam.85 <- Z
load('data/dse.claris.tx.rcp85.jja.eof.rda')
Z4$tx.jja.85 <- Z
load('data/dse.claris.tx.rcp85.son.eof.rda')
Z4$tx.son.85 <- Z

## Wet-day frequency
load('data/dse.claris.fw.rcp45.djf.eof.rda')
Z4$fw.djf.45 <- Z
load('data/dse.claris.fw.rcp45.mam.eof.rda')
Z4$fw.mam.45 <- Z
load('data/dse.claris.fw.rcp45.jja.eof.rda')
Z4$fw.jja.45 <- Z
load('data/dse.claris.fw.rcp45.son.eof.rda')
Z4$fw.son.45 <- Z

load('data/dse.claris.fw.rcp26.djf.eof.rda')
Z4$fw.djf.26 <- Z
load('data/dse.claris.fw.rcp26.mam.eof.rda')
Z4$fw.mam.26 <- Z
load('data/dse.claris.fw.rcp26.jja.eof.rda')
Z4$fw.jja.26 <- Z
load('data/dse.claris.fw.rcp26.son.eof.rda')
Z4$fw.son.26 <- Z

load('data/dse.claris.fw.rcp85.djf.eof.rda')
Z4$fw.djf.85 <- Z
load('data/dse.claris.fw.rcp85.mam.eof.rda')
Z4$fw.mam.85 <- Z
load('data/dse.claris.fw.rcp85.jja.eof.rda')
Z4$fw.jja.85 <- Z
load('data/dse.claris.fw.rcp85.son.eof.rda')
Z4$fw.son.85 <- Z

## Wet-day mean precipitation
load('data/dse.claris.mu.rcp45.djf.eof.rda')
Z4$mu.djf.45 <- Z
load('data/dse.claris.mu.rcp45.mam.eof.rda')
Z4$mu.mam.45 <- Z
load('data/dse.claris.mu.rcp45.jja.eof.rda')
Z4$mu.jja.45 <- Z
load('data/dse.claris.mu.rcp45.son.eof.rda')
Z4$mu.son.45 <- Z

load('data/dse.claris.mu.rcp26.djf.eof.rda')
Z4$mu.djf.26 <- Z
load('data/dse.claris.mu.rcp26.mam.eof.rda')
Z4$mu.mam.26 <- Z
load('data/dse.claris.mu.rcp26.jja.eof.rda')
Z4$mu.jja.26 <- Z
load('data/dse.claris.mu.rcp26.son.eof.rda')
Z4$mu.son.26 <- Z

load('data/dse.claris.mu.rcp85.djf.eof.rda')
Z4$mu.djf.85 <- Z
load('data/dse.claris.mu.rcp85.mam.eof.rda')
Z4$mu.mam.85 <- Z
load('data/dse.claris.mu.rcp85.jja.eof.rda')
Z4$mu.jja.85 <- Z
...
shinyServer(function(input, output, session) {
  ...
  output$plotndays <- renderPlot({
    if(!is.null(input$threshold8)) {
      ...
      gcnames <- names(Z4[[li]])[-c(1,2,length(Z4[[1]]))]
      im <- is.element(gcmnames,input$im)
      is <- srt.t2m[is.element(tx.locs,as.character(input$location8))]
