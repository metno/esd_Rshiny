...
navbarPage("The Nordic region climate atlas",
    tabPanel("Maps", 
             plotOutput("maps", width = "60%", height = "40%"),
             column(3,
                    selectInput("param1", 
                                label = "Element",
    ...
    tabPanel("Single location", 
             plotOutput("plot", width = "60%", height = "40%"),
             column(3,
                   uiOutput("locations2")),    
             column(3,
                    selectInput("param2", 
        ...
        tabPanel("Multiple locations", 
                 plotOutput("plot.multi", width = "60%", height = "40%"),
            column(3,
                    sliderInput("lon3", 
                             label = "Longitudes",
                             min = 0, max = 30, value = c(0, 30))),
    ...
    tabPanel("Probabilities", 
             plotOutput("plot.prob", width = "60%", height = "40%"),
             column(2,
...
tabPanel("Single model",  ## Unfinished!
         plotOutput("plot1model", width = "60%", height = "40%"), 
         column(3,
                selectInput("im7", 
                            label = "Model",
                            choices = gcmnames,
...
tabPanel("Warm/cold days",
         plotOutput("plotndays", width = "60%", height = "40%"),
         column(3,
...
tabPanel("Quality",  ## Unfinished!
         plotOutput("map.quality", width = "60%", height = "40%"),
             column(2,
                    selectInput("param6", 
                                label = "Element",
                                choices = c("Temperature","Wet-day freq.",
